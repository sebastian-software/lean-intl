...
import { IsWellFormedCurrencyCode } from "./6.locales-currencies-tz.js"
 ...
 */
export function /* 11.1.1.1 */ InitializeNumberFormat(
  numberFormat,
  locales,
  options
) {
    ...
    if (p === "number") {
      ...
      if (isNaN(x)) {
        ...
        if (numSys[nums]) {
          ...
          n = String(n).replace(/\d/g, (digit) => digits[digit])
        } else
