 ...
 */
export function /* 9.2.5 */ ResolveLocale(
  availableLocales,
  requestedLocales,
  options,
 ...
 * The following steps are taken:
 */
export function /* 9.2.6 */ LookupSupportedLocales(
  availableLocales,
  requestedLocales
) {
  ...
  while (k < len) {
    ...
    //    BestAvailableLocale abstract operation (defined in 9.2.2) with
    //    arguments availableLocales and noExtensionsLocale.
    let availableLocale = BestAvailableLocale(
      availableLocales,
      noExtensionsLocale
    )
 ...
 */
export function /* 9.2.7 */ BestFitSupportedLocales(
  availableLocales,
  requestedLocales
) {
 ...
 */
export function /* 9.2.8 */ SupportedLocales(
  availableLocales,
  requestedLocales,
  options
) {
 ...
 * value if necessary.
 */
export function /* 9.2.9 */ GetOption(
  options,
  property,
  type,
  values,
  ...
  if (value !== undefined) {
    ...
    if (values !== undefined) {
      ...
      if (arrIndexOf.call(values, value) === -1)
        throw new RangeError(
          `'${value}' is not an allowed value for \`${property}\``
        )
    }
 ...
 */
export function /* 9.2.10 */ GetNumberOption(
  options,
  property,
  minimum,
  maximum,
