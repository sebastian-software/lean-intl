...
assertNotEqual(
  RegExp.input,
  "a foo test",
  "After invoking __disableRegExpRestore, RegExp.input should not be cached and restored"
);
assertNotEqual(
  RegExp.lastMatch,
  "foo",
  "After invoking __disableRegExpRestore, RegExp.lastMatch should not be cached and restored"
);
