...
assert(
  ...
  "£59.88",
  "currency with fragtional digits"
);

assert(
  new IntlPolyfill.DateTimeFormat("en", {
    month: "numeric",
    day: "numeric"
  }).format(new Date("2016/05/16")),
  "5/16",
  "month and day"
);
...
// Issue #152
assert(
  new IntlPolyfill.DateTimeFormat("en-US", {
    hour: "numeric",
    minute: "numeric"
  }).format(newDateUTC("Tue Mar 01 2016 14:08:39 GMT-0500 (EST)")),
  "7:08 PM",
...
// Issue #173
assert(
  new IntlPolyfill.DateTimeFormat("en-GB", {
    hour: "2-digit",
    hour12: false,
    minute: "numeric"
  }).format(new Date(1983, 9, 13)),
  "00:00",
  "GB should use 2-digits for hours and minutes without hour12"
);
...
assert(
  new IntlPolyfill.DateTimeFormat("en", {
    month: "long",
    year: "numeric"
  }).format(new Date("2016/01/16")),
  "January 2016",
  "month and year should be long"
);
...
assert(
  ...
  "Fri",
  "single weekday should be short"
);
...
assert(
  ...
  "00",
  "single minute should be 2-digit"
);
...
assert(
  ...
  "00",
  "single second should be 2-digit"
);
