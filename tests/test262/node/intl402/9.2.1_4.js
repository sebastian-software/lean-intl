 ...
 * the IntlPolyfill object, until f returns a falsy value. It returns the result of the
 * last call to f, mapped to a boolean.
 * @param {Function} f the function to call for each service constructor in
 *     the IntlPolyfill object.
...
function testWithIntlConstructors(f) {
    ...
    return constructors.every(function (constructor) {
        var Constructor = IntlPolyfill[constructor];
        var result;
        try {
 ...
 * IntlPolyfill.Collator, IntlPolyfill.NumberFormat, or IntlPolyfill.DateTimeFormat.
 * @param {object} Constructor a constructor
 * @return {string} the name of the constructor
 */
function getConstructorName(Constructor) {
    switch (Constructor) {
        case IntlPolyfill.Collator:
            return "Collator";
        case IntlPolyfill.NumberFormat:
            return "NumberFormat";
        case IntlPolyfill.DateTimeFormat:
            return "DateTimeFormat";
        default:
            throw new Error("test internal error: unknown Constructor");
    }
}
...
function taintDataProperty(obj, property) {
    Object.defineProperty(obj, property, {
        set: function(value) {
            throw new Error("Client code can adversely affect behavior: setter for " + property + ".");
        },
        enumerable: false,
        configurable: true
    });
...
function taintMethod(obj, property) {
    Object.defineProperty(obj, property, {
        value: function() {
            throw new Error("Client code can adversely affect behavior: method " + property + ".");
        },
        writable: true,
        enumerable: false,
        configurable: true
 ...
 * of IntlPolyfill.Collator, IntlPolyfill.NumberFormat, IntlPolyfill.DateTimeFormat.
...
function testOption(Constructor, property, type, values, fallback, testOptions) {
    ...
    testValues.forEach(function (value) {
        ...
        if (noReturn) {
            if (obj.resolvedOptions().hasOwnProperty(property)) {
                throw new Error("Option property " + property + " is returned, but shouldn't be.");
            }
        } else {
            actual = obj.resolvedOptions()[property];
            if (isILD) {
                if (actual !== undefined && values.indexOf(actual) === -1) {
                    throw new Error("Invalid value " + actual + " returned for property " + property + ".");
                }
            } else {
                if (type === "boolean") {
                ...
                if (actual !== expected && !(isOptional && actual === undefined)) {
                    throw new Error("Option value " + value + " for property " + property +
    ...
    if (type === "string") {
        ...
        invalidValues.forEach(function (value) {
            ...
            if (error === undefined) {
                throw new Error("Invalid option value " + value + " for property " + property + " was not rejected.");
            } else if (error.name !== "RangeError") {
                throw new Error("Invalid option value " + value + " for property " + property + " was rejected with wrong error " + error.name + ".");
            }
        });
    }
    ...
    if (!noReturn) {
        ...
        if (!(isOptional && actual === undefined)) {
            if (fallback !== undefined) {
                if (actual !== fallback) {
                    throw new Error("Option fallback value " + fallback + " for property " + property +
...
function testProperty(obj, property, valid) {
    ...
    if (!desc.writable) {
        throw new Error("Property " + property + " must be writable.");
    }
    if (!desc.enumerable) {
        throw new Error("Property " + property + " must be enumerable.");
    }
    if (!desc.configurable) {
        throw new Error("Property " + property + " must be configurable.");
    }
    var value = desc.value;
    var isValid = (typeof valid === "function") ? valid(value) : (valid.indexOf(value) !== -1);
    if (!isValid) {
        throw new Error("Property value " + value + " is not allowed for property " + property + ".");
    }
}
...
function mustHaveProperty(obj, property, valid) {
    if (!obj.hasOwnProperty(property)) {
        throw new Error("Object is missing property " + property + ".");
    }
    testProperty(obj, property, valid);
}
...
function mustNotHaveProperty(obj, property) {
    if (obj.hasOwnProperty(property)) {
        throw new Error("Object has property it mustn't have: " + property + ".");
    }
}
...
function testForUnwantedRegExpChanges(testFunc) {
    ...
    regExpProperties.forEach(function (property) {
        if (RegExp[property] !== regExpPropertiesDefaultValues[property]) {
            throw new Error("RegExp has unexpected property " + property + " with value " +
                RegExp[property] + ".");
        }
    });
}
 ...
 * @param {Object} options the options to pass to IntlPolyfill.NumberFormat. Options
...
function testNumberFormat(locales, numberingSystems, options, testData) {
    locales.forEach(function (locale) {
        numberingSystems.forEach(function (numbering) {
            ...
            var format = new IntlPolyfill.NumberFormat([locale + "-u-nu-" + numbering], options);
            ...
            function getPatternParts(positive) {
                ...
                if (match === null) {
                    throw new Error("Unexpected formatted " + n + " for " +
            ...
            if (format.resolvedOptions().numberingSystem === numbering) {
                ...
                Object.getOwnPropertyNames(testData).forEach(function (input) {
                    ...
                    if (actual !== expected) {
                        throw new Error("Formatted value for " + input + ", " +
                        format.resolvedOptions().locale + " and options " +
...
function getDateTimeComponentValues(component) {
    ...
    if (result === undefined) {
        throw new Error("Internal error: No values defined for date-time component " + component + ".");
    }
    return result;
}
...
function testValidDateTimeComponentValue(component, value) {
    if (getDateTimeComponentValues(component).indexOf(value) === -1) {
        throw new Error("Invalid value " + value + " for date-time component " + component + ".");
    }
    return true;
}
...
function testArraysAreSame(expected, actual) {
    ...
    for (i = 0; i < Math.max(actual.length, expected.length); i++) {
        if (actual[i] !== expected[i]) {
            throw new Error("Result array element at index " + i + " should be \"" +
...
testWithIntlConstructors(function (Constructor) {
    ...
    if (error === undefined) {
        throw new Error("Null as locale list was not rejected.");
    } else if (error.name !== "TypeError") {
        throw new Error("Null as locale list was rejected with wrong error " + error.name + ".");
    }    
    ...
    if (supportedForNumber.length !== supportedForEmptyList.length) {
        throw new Error("Supported locales differ between numeric and empty list input.");
    }
    var supportedForBoolean = Constructor.supportedLocalesOf(true);
    if (supportedForBoolean.length !== supportedForEmptyList.length) {
        throw new Error("Supported locales differ between boolean and empty list input.");
    }
