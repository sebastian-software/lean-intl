...
var locale = new IntlPolyfill.DateTimeFormat(undefined, {localeMatcher: "lookup"}).resolvedOptions().locale;
if (!isCanonicalizedStructurallyValidLanguageTag(locale)) {
    throw new Error("DateTimeFormat returns invalid locale " + locale + ".");
}
 }