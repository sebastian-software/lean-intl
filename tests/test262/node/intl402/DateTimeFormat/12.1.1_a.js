...
function runner() {    var passed = false;    runTheTest();    passed = true;    return passed;}function runTheTest () {// Copyright 2013 Mozilla Corporation. All rights reserved.
// This code is governed by the BSD license found in the LICENSE file.
...
testForUnwantedRegExpChanges(function () {
    new IntlPolyfill.DateTimeFormat("de-DE-u-ca-gregory");
});

testForUnwantedRegExpChanges(function () {
    new IntlPolyfill.DateTimeFormat("de-DE-u-ca-gregory", {timeZone: "UTC"});
});
 }