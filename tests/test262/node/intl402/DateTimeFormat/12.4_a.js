...
es5id: 12.4_a
description: >
    Tests that IntlPolyfill.DateTimeFormat instances have the specified
    properties.
...
if (toStringValue !== "[object Object]") {
    throw new Error("IntlPolyfill.DateTimeFormat instance produces wrong [[Class]] - toString returns " + toStringValue + ".");
}
 }