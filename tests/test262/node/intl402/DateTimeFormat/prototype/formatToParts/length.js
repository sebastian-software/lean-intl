...
/*---
description: IntlPolyfill.DateTimeFormat.prototype.formatToParts.length. 
propertyHelper.js
---*/

assert.sameValue(IntlPolyfill.DateTimeFormat.prototype.formatToParts.length, 0);

verifyNotEnumerable(IntlPolyfill.DateTimeFormat.prototype.formatToParts, "length");
verifyNotWritable(IntlPolyfill.DateTimeFormat.prototype.formatToParts, "length");
verifyConfigurable(IntlPolyfill.DateTimeFormat.prototype.formatToParts, "length");
 }