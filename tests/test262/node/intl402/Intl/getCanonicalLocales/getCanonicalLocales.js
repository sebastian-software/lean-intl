...
assert.sameValue(
  typeof IntlPolyfill.getCanonicalLocales,
  'function',
  '`typeof IntlPolyfill.getCanonicalLocales` is `function`'
);

verifyNotEnumerable(IntlPolyfill, 'getCanonicalLocales');
verifyWritable(IntlPolyfill, 'getCanonicalLocales');
verifyConfigurable(IntlPolyfill, 'getCanonicalLocales');
 }