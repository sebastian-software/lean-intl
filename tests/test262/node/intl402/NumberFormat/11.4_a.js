...
es5id: 11.4_a
description: >
    Tests that IntlPolyfill.NumberFormat instances have the specified
    properties.
...
assert.sameValue(toStringValue, "[object Object]", "IntlPolyfill.NumberFormat instance produces wrong [[Class]] - toString returns " + toStringValue + ".");
 }