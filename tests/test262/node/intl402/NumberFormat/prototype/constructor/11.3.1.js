...
assert.sameValue(IntlPolyfill.NumberFormat.prototype.constructor, IntlPolyfill.NumberFormat, "IntlPolyfill.NumberFormat.prototype.constructor is not the same as IntlPolyfill.NumberFormat");
 }