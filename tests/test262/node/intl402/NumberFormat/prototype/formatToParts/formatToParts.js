...
assert.sameValue(
  typeof IntlPolyfill.NumberFormat.prototype.formatToParts,
  'function',
  '`typeof IntlPolyfill.NumberFormat.prototype.formatToParts` is `function`'
);

verifyNotEnumerable(IntlPolyfill.NumberFormat.prototype, 'formatToParts');
verifyWritable(IntlPolyfill.NumberFormat.prototype, 'formatToParts');
verifyConfigurable(IntlPolyfill.NumberFormat.prototype, 'formatToParts');
 }