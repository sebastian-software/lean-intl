...
/*---
description: IntlPolyfill.NumberFormat.prototype.formatToParts.length. 
propertyHelper.js
---*/

assert.sameValue(IntlPolyfill.NumberFormat.prototype.formatToParts.length, 0);

verifyNotEnumerable(IntlPolyfill.NumberFormat.prototype.formatToParts, "length");
verifyNotWritable(IntlPolyfill.NumberFormat.prototype.formatToParts, "length");
verifyConfigurable(IntlPolyfill.NumberFormat.prototype.formatToParts, "length");
 }