...
description: Tests that IntlPolyfill.PluralRules can be subclassed.
...
var referencePluralRules = new IntlPolyfill.PluralRules(locales);
var referenceSelected = a.map(referencePluralRules.select.bind(referencePluralRules));

class MyPluralRules extends IntlPolyfill.PluralRules {
