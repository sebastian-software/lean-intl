...
description: IntlPolyfill.PluralRules.length.
author: Zibi Braniecki
propertyHelper.js
---*/

assert.sameValue(IntlPolyfill.PluralRules.length, 0);

verifyNotEnumerable(IntlPolyfill.PluralRules, "length");
verifyNotWritable(IntlPolyfill.PluralRules, "length");
verifyConfigurable(IntlPolyfill.PluralRules, "length");
 }