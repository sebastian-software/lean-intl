...
/*---
esid: sec-IntlPolyfill.PluralRules.prototype.resolvedOptions
description: >
    Tests that the object returned by
    IntlPolyfill.PluralRules.prototype.resolvedOptions  has the right
    properties.
author: Zibi Braniecki
testIntl.js
---*/

var actual = new IntlPolyfill.PluralRules().resolvedOptions();

var actual2 = new IntlPolyfill.PluralRules().resolvedOptions();
if (actual2 === actual) {
