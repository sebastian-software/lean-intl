...
description: >
    Tests that IntlPolyfill.PluralRules has a supportedLocalesOf property, and
    it works as planned.
author: Zibi Braniecki
---*/

var defaultLocale = new IntlPolyfill.PluralRules().resolvedOptions().locale;
var notSupported = 'zxx'; // "no linguistic content"
var requestedLocales = [defaultLocale, notSupported];
    
var supportedLocales;

if (!IntlPolyfill.PluralRules.hasOwnProperty('supportedLocalesOf')) {
    throw new Error("IntlPolyfill.PluralRules doesn't have a supportedLocalesOf property.");
}
    
supportedLocales = IntlPolyfill.PluralRules.supportedLocalesOf(requestedLocales);
