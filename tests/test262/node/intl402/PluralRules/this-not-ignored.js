...
/*---
esid: sec-IntlPolyfill.PluralRules
...
testWithIntlConstructors(function (Constructor) {
    ...
    obj = new Constructor();
    newObj = IntlPolyfill.PluralRules.call(obj);
    if (obj === newObj) {
      throw new Error("PluralRules object created with \"new\" was not ignored as this-value.");
    }
    ...
    newObj = IntlPolyfill.PluralRules.call(obj);
    if (obj === newObj) {
      throw new Error("PluralRules object created with constructor as function was not ignored as this-value.");
    }
